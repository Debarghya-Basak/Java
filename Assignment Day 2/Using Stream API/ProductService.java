...
public class ProductService {
    ...
    //USING STREAM API
    //I have changed the returntype and used returntype List for this function
    public List<Product> getProduct(String name){
        ...
        //I have used contains function so that it can find all the products with the closest search
